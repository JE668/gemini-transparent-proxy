...
export const HIGH_QUOTA_MODELS = [
  ...
  // ============ Agent 模型（走 Interactions API，Chat Completions 兼容层不可用） ============
  {
    ...
    owned_by: 'google',
    limit: 50,
    description: 'Deep Research Agent — ⚡ 走 Interactions API, 用于深度研究，有独立配额'
  },
  {
  ...
  },
  {
    ...
    owned_by: 'google',
    limit: 50,
    description: 'Antigravity Agent — ⚡ 走 Interactions API'
  },
];
