...
//   - gemini-2.5-pro 免费层 RPD=20（2026-07-22 核对后加回）；RPM/TPM 待用户从 AI Studio rate-limit 页确认，暂给宽松值以免误拦。
...
export const HIGH_QUOTA_MODELS = [
  ...
  },
  {
    ...
    owned_by: 'google',
    limit: 20,
    description: 'Gemini 2.5 Pro — RPM 2 | RPD 20 | TPM 1,000,000（RPD 已确认；RPM/TPM 待 AI Studio rate-limit 页核对）'
  },
