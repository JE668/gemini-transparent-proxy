...
// =============================================================================
const pageStyle = { fontFamily: 'Inter, system-ui, -apple-system, "PingFang SC", "Microsoft YaHei", sans-serif', minHeight: '100vh' };
...
const MODEL_COLORS = {
  'gemma-3-27b-it': '#6366f1', 'gemma-3-12b-it': '#8b5cf6',
...
export default function DashboardPage() {
     ...
     <div style={{ ...pageStyle, ...theme.page }}>
       <div style={containerStyle}>
         ...
         <div style={{ ...statusBarStyle, ...theme.statusBar }}>
           ...
           <StatusEmoji emoji="⚠️" label="Error" value={health?.errorRate ? `${health.errorRate}%` : '0%'} valueColor={(health?.errorRate || 0) > 5 ? '#ef4444' : '#22c55e'} />
           <div style={dividerStyle} />
           <StatusEmoji emoji="🔄" label="Reset" value={formatCountdown(countdown)} mono />
         </div>
 ...
 function ModelCard({ item, isSelected, theme }) {
   ...
   return (
     <div style={{ ...cardStyle, ...theme.card, border: isSelected ? `2px solid ${color}` : theme.card.border, boxShadow: isSelected ? `0 20px 25px -5px ${color}20` : theme.card.boxShadow, transform: isSelected ? 'translateY(-4px)' : 'none' }}>
